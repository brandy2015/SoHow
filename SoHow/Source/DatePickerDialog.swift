...
//        guard let appDelegate = UIApplication.shared.SceneDelegate else { fatalError() }
//
//        PresentShareView(VC: <#T##UIViewController#>, URLs: <#T##[URL]#>, on: <#T##UIView#>)
//
...
//        guard let window = windowx ,window.isKeyWindow else {print("无window");return}
        ...
        windowx?.addSubview(self)
        windowx?.bringSubviewToFront(self)
        windowx?.endEditing(true)
